...
import { Map, BarChart3, ArrowLeftRight, ArrowUpRight } from "lucide-react"
...
export function FeatureSections() {
  ...
  const sections = [
    { id: "meaningMap", icon: Map, ...t.features.meaningMap },
    { id: "similarity", icon: BarChart3, ...t.features.similarity },
    { id: "compare", icon: ArrowLeftRight, ...t.features.comparison },
  ]
